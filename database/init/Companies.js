...
const companies = [
  ...
  },
  {
    ...
    "company_overview": {
      "description": "Tata Consultancy Services (TCS) is an Indian multinational IT services and consulting company, and a flagship entity of the Tata Group. As one of the largest IT service providers in the world, TCS offers a comprehensive, integrated portfolio of business, technology, and engineering services and solutions. Its global presence spans across numerous industries, including banking, retail, and healthcare. TCS is known for its extensive workforce, strong corporate training programs, and significant contributions to digital transformation projects for Fortune 500 companies worldwide, focusing on areas like cloud, AI, and cybersecurity.",
  ...
  },
  {
    ...
    "company_overview": {
      "description": "Salesforce is the global leader in cloud-based Customer Relationship Management (CRM) software. Its platform, Customer 360, provides a unified view of customers for marketing, sales, commerce, and service departments, enabling companies to deliver personalized experiences. Beyond its flagship CRM product, Salesforce offers a suite of enterprise applications focused on analytics, application development, and marketing automation. The company is also known for its Trailhead learning platform and its philanthropic 1-1-1 model, where it donates 1% of its equity, product, and employee time to communities worldwide.",
  ...
  },
  {
    ...
    "company_overview": {
      "description": "AFCONS Infrastructure Limited, part of the Shapoorji Pallonji Group, is a leading infrastructure development company in India with a global footprint. The company has a strong reputation for executing large and complex engineering, procurement, and construction (EPC) projects. Its expertise spans various sectors, including marine and industrial, surface transport, urban infrastructure, and hydro & underground works. AFCONS is known for its technological prowess and commitment to quality and safety, having delivered numerous landmark projects like bridges, tunnels, ports, and metro rail systems, both in India and internationally.",
  ...
  },
  {
    ...
    "company_overview": {
      "description": "Mahindra & Mahindra (M&M) is an Indian multinational automotive manufacturing corporation and a key part of the Mahindra Group. It is a market leader in utility vehicles and tractors in India and is one of the largest vehicle manufacturers by production in the country. The company's diverse portfolio also includes electric vehicles, commercial vehicles, and two-wheelers. M&M is known for its rugged and reliable vehicles and has a growing international presence. The company is committed to innovation, particularly in the areas of electric mobility and sustainable farming solutions.",
  ...
  },
  {
    ...
    "company_overview": {
      "description": "Mercedes-Benz Research and Development India (MBRDI) is the largest research and development center of Mercedes-Benz Group AG outside of Germany. Headquartered in Bangalore, MBRDI is a crucial hub for the company's global innovation network. Engineers at MBRDI contribute to a wide range of activities, including computer-aided design and engineering (CAD/CAE), software development for infotainment and autonomous driving systems, and data analytics. This center plays a pivotal role in developing the next generation of Mercedes-Benz vehicles, focusing on connectivity, autonomous driving, shared services, and electric mobility (CASE).",
